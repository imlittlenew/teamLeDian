    ...
    return (
      <>
        ...
        >
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <div className="input-group mb-3 fs-5">
                    <div className="input-group-img d-flex align-items-center justify-content-center rounded-start-2">
                      <img
                        className="imgicon w-50"
                        src="./img/Member_Area/email.png"
                        alt=" "
                      />
                    </div>
                    <input
                ...
                <div className="modal-footer">
                  <button
                    type="button"
                    className="btn btn-forgotPassword fs-5"
          ...
          <div className="position-relative">
            <img
              src="./img/Member_Area/LeDian_LOGO-06.png"
              className="rightlogoimg"
              alt=" "
            />
          </div>
          <div id="header-image">
                  ...
                  >
                    ...
                    <div className="input-group mb-5">
                      <div className="input-group-img d-flex align-items-center justify-content-center rounded-start-2">
                        <img
                          className="imgicon w-50"
                          src="./img/Member_Area/password.png"
                          alt=" "
                        />
                      </div>
                      <input
                    ...
                    <div className="login-box mb-5"></div>
                    <div className="social-login mb-5"></div>
                  </form>
                  <div className="bottom text-center rounded-bottom-4">
                    登入及代表您同意{" "}
                    <button className="fw-semibold">使用者條款</button> 和
                  ...
                  <form className="container" action="/signup" method="post">
                    ...
                    <div className="u-form-group mb-5">
                      <button
                        type="button"
                        className="btn btn-login w-100"
                        onClick={this.signup_click}
                      >
                        <h5 className="fw-bold m-1 fs-4">註冊</h5>
                      </button>
                    </div>
                    <div className="login-box mb-3"></div>
                    <div className="social-login mb-3"></div>
                  </form>
                  <div className="bottom text-center rounded-bottom-4">
                    登入及代表您同意{" "}
                    <button className="fw-bold ">使用者條款</button> 和
