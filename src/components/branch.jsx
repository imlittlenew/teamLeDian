  ...
  getData = async () => {
    try {
      const resultBranch = await Axios.get(
        `http://localhost:8000/branch/${this.props.match.params.id}`
      );
      const resultBrand = await Axios.get(
        `http://localhost:8000/brand/${this.props.match.params.id}`
      );
                          ...
                          >
                            <div className="card branchCard">
                              <div className="image">
                                ...
                                />
                                <img
                                  src={`/img/logo/${branch.brand_id}.png`}
                                  className="logo"
                                  alt="..."
                                />
                              </div>
